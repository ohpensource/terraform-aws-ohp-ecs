...
variable "cluster_name" {
  type        = string
  description = "The name of the ECS cluster where service is located"
}
variable "cluster_arn" {
  type        = string
  description = "The Arn of the ECS cluster where service is located"
}

# IAM 
variable "task_role_arn" { default = "" }
variable "task_exec_role_arn" { default = "" }
variable "permissions_boundary" { default = "" }
variable "task_policy_arns" { default = [] }
variable "task_exec_policy_arns" {
  default = [
...
# Load Balancers
variable "enable_ecs_load_balancers" { default = false }

# Autoscalaing
variable "autoscaling_enabled" { default = false }
